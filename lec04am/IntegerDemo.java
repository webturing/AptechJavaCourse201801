...
public class IntegerDemo {
	public static void main(String[] args) {
		...
		// radix
		int n = 1023;
		System.out.println(Integer.toString(n));// 十进制
		...
		System.out.println(Integer.toString(n, 10));// 十进制
		System.out.println(Integer.toString(n, 2));
		System.out.println(Integer.toString(n, 16));// 十六进制
		System.out.println(Integer.toString(n, 8));// 八进制
